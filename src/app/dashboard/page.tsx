...
// import { useFavorites } from "@/app/components/favorites/hooks/useFavorites";
...
export default function Home() {
                    ...
                    <div className="flex-1">
                      <div className="flex-col-2">
                        <div className="mb-4">
                          ...
                          <h4 className="text-lg font-semibold text-gray-800 line-clamp-2 flex-1 pr-2">
                            {book.title}
                          </h4>
  ...
  {/* Mostrar error de favoritos si existe */}
  {favoritesError && (
    <div className="fixed bottom-4 right-4 bg-red-50 border border-red-200 rounded-lg p-4 shadow-lg z-50">
      <div className="flex items-center">
        ...
        <p className="text-red-600 text-sm">{favoritesError}</p>
      </div>
    </div>
  )}
</div>
